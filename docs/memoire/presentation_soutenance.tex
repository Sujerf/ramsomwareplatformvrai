...
% Slide séparateur de section — fond bleu plein, titre centré
\newcommand{\sectionslide}[2]{%
  ...
  \begin{frame}[plain,noframenumbering]%
    \vfill
    \begin{center}
      {\fontsize{9}{9}\selectfont\bfseries\color{white!60}
        \MakeUppercase{Partie} #1}\\[14pt]
...
\begin{frame}[plain,noframenumbering]
  \vfill
  \begin{center}
    {\fontsize{34}{34}\selectfont\bfseries\color{white}
      Merci pour votre attention}\\[16pt]
    {\normalsize\color{white!80}
      Codjo Fréjus Loïc SANGRONIO}\\[6pt]
    {\small\color{white!65}
      Licence Informatique \textbar\ Option Sécurité Informatique \textbar\ IFRI-UAC}
  \end{center}
  \vfill
\end{frame}
}
