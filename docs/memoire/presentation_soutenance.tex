...
% =========================================================================
\definecolor{primary}  {RGB}{228,  92,  16}   % orange IFRI
\definecolor{dprimary} {RGB}{168,  58,   8}   % orange foncé
\definecolor{darkbg}   {RGB}{ 22,  28,  48}   % fond sombre (slides spéciaux)
\definecolor{light}    {RGB}{255, 243, 230}   % orange très pâle
...
% ─── Filigrane : arcs concentriques élégants depuis le coin bas-droite ───
\setbeamertemplate{background}{%
  \begin{tikzpicture}[overlay,remember picture]
    \foreach \rr in {2.5,4.5,6.5,8.5,10.5,12.5}{%
      \draw[primary,opacity=0.038,line width=0.9pt]
        ([xshift=\rr cm]current page.south east)
        arc(0:90:\rr cm);
    }
    \fill[primary,opacity=0.07]
      (current page.north west) --
      ([xshift=0.42cm]current page.north west) --
      ([yshift=-0.42cm]current page.north west) -- cycle;
  \end{tikzpicture}%
}
...
\newcommand{\sectionslide}[2]{%
  \begin{frame}[plain,noframenumbering]%
    \begin{tikzpicture}[overlay,remember picture]%
      ...
      \foreach \rr in {3.0,5.5,8.0,10.5}{%
        \draw[primary,opacity=0.06,line width=0.9pt]
          ([xshift=\rr cm]current page.south east) arc(0:90:\rr cm);
      }
...
\setbeamertemplate{background}{%
  \begin{tikzpicture}[overlay,remember picture]
    ...
    \foreach \rr in {3.0,5.5,8.0,10.5,13.0}{%
      \draw[primary,opacity=0.07,line width=1.0pt]
        ([xshift=\rr cm]current page.south east) arc(0:90:\rr cm);
    }
  \end{tikzpicture}%
}
...
\begin{frame}[plain,noframenumbering]
  \begin{tikzpicture}[overlay,remember picture]
    ...
    % Arcs filigrane droit
    \foreach \rr in {3.0,5.5,8.0,10.5}{%
      \draw[primary,opacity=0.055,line width=0.8pt]
        ([xshift=\rr cm]current page.south east) arc(0:90:\rr cm);
    }
    % Item 1
...
\begin{frame}[plain,noframenumbering]
  \begin{tikzpicture}[overlay,remember picture]
    ...
    \foreach \rr in {3.0,5.5,8.0,10.5,13.0}{%
      \draw[white,opacity=0.06,line width=1.0pt]
        ([xshift=\rr cm]current page.south east) arc(0:90:\rr cm);
    }
