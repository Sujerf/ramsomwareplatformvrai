...
\newcommand{\sectionslide}[2]{%
  \begin{frame}[plain,noframenumbering]%
    \begin{tikzpicture}[overlay,remember picture]
      ...
      \node[font=\fontsize{20}{26}\selectfont\bfseries\color{dprimary},
            anchor=center, text width=9.5cm, align=center]
        at ([xshift=11.05cm, yshift=4.68cm]current page.south west) {\hyphenpenalty=10000 #2};
      % Pied-de-page bleu
      \fill[primary]
        (current page.south west) rectangle
...
\begin{frame}[plain,noframenumbering]
  \begin{tikzpicture}[overlay,remember picture]
    ...
    % Logos — décalés sous les liserés (0.36cm = ~10pt)
    \node[anchor=north west,inner sep=0pt,
          at={([xshift=8pt,yshift=-0.5cm]current page.north west)}]
      {}; % ancre fictive
    \node[anchor=north west]
      at ([xshift=8pt,yshift=-0.52cm]current page.north west)
      {\includegraphics[height=1.10cm]{logoUAC1}};
    \node[anchor=north east]
      at ([xshift=-8pt,yshift=-0.52cm]current page.north east)
      {\includegraphics[height=1.10cm]{logoIfri}};
    % Titre principal — positionné sous les logos
    \node[anchor=center,
          font=\fontsize{16}{22}\selectfont\bfseries,
          text=white, text width=13.5cm, align=center]
      at ([yshift=0.9cm]current page.center)
      {Conception et mise en place d'un système de\\[4pt]
       détection et de réponse aux attaques ransomware\\[4pt]
       dans un environnement contrôlé};
    % Nom
    \node[anchor=center,
    ...
    \node[anchor=center,
          ...
          text=white]
      at ([yshift=-2.10cm]current page.center)
      {24 juin 2026};
    % Encadreur
    \node[anchor=south west,font=\scriptsize,text=white!80,align=left,inner sep=0pt]
...
\begin{frame}[plain,noframenumbering]
  \begin{tikzpicture}[overlay,remember picture]
    ...
    \node[anchor=east,font=\tiny\color{white},inner sep=0pt]
      ...
      {24 juin 2026};
    % Titre principal
    \node[anchor=center,font=\fontsize{36}{36}\selectfont\bfseries,text=white]
      at ([yshift=1.2cm]current page.center)
      {Merci pour votre attention};
    % Sous-titre
    \node[anchor=center,font=\fontsize{13}{16}\selectfont,text=white!80]
      at ([yshift=0.0cm]current page.center)
      {Codjo Fréjus Loïc SANGRONIO};
    \node[anchor=center,font=\fontsize{11}{14}\selectfont,text=white!65]
