...
Excellence Monsieur le Président du jury, Mesdames et Messieurs les membres du jury, bonjour.
  Permettez-nous de vous exprimer notre profonde reconnaissance pour avoir répondu présents
  à ce rendez-vous. Le sujet ayant fait l'objet de notre étude est intitulé~:
  ...
  sur des machines virtuelles réelles. Nous restons à votre disposition pour vos questions
  à la fin.
\pivot{Voici comment s'articule cette présentation.}

\notehead{2/25}{SOMMAIRE — 0:30}
Notre présentation s'articule en cinq parties~: le contexte et la problématique,
  la revue de littérature, la conception de la solution, sa réalisation avec les
  résultats obtenus, puis la conclusion. Nous terminerons par une courte démonstration
...
Les solutions existantes ont chacune leurs limites. Les antivirus classiques
  ...
  de portée pour la majorité des entreprises, hôpitaux et organisations à budget
  limité. C'est dans cet espace que se positionne RansomShield~: une solution
  comportementale, open-source, déployable sur toute infrastructure, avec un
  contrôle humain garanti à chaque étape. Voyons maintenant comment ce système a été conçu.
...
Nous avons validé le système sur cinq scénarios d'attaque, de sept à vingt-deux
  ...
  jusqu'à la timeline. Notons honnêtement une limite~: les tests ont été
...
Excellence Monsieur le Président du jury, Mesdames et Messieurs les membres du jury,
  RansomShield est une solution fonctionnelle qui couvre tout le cycle
  ...
  partie simulées. Nous n'avons nullement la prétention d'avoir épuisé le sujet.
  Les perspectives sont claires~: ajouter le chiffrement HTTPS,
  ...
  Nous vous remercions pour votre attention et restons à votre disposition pour vos
  questions.
