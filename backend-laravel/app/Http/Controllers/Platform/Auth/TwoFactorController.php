...
class TwoFactorController extends Controller
{
    ...
    // ── Challenge (après login password) ─────────────────────────────────────
    ...
    public function showSetup(): View
    {
        ...
        if (! $user->hasTwoFactorEnabled()) {
            // Génère un secret temporaire stocké en session le temps de la confirmation
    ...
    public function enable(Request $request): RedirectResponse
    {
        ...
        return redirect()->route('platform.two-factor.setup')
            ->with('success', 'Authentification à deux facteurs activée. Elle sera requise à votre prochaine connexion.');
    }
